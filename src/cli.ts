...
const FLAG_IRRELEVANT: Record<string, FlagIrrelevance[]> = {
  ...
  push: [],
  pull: [],
  // recovery-kit reads --from-locator-file/--identity/--out/--force plus its own two
  // flags; nothing another command accepts is silently ignored in a likely-typo way.
  'recovery-kit': [],
  schedule: [],
  wallet: [],
